"""
Compari.ro feed adapter — implements FeedPort.
"""
...
from bapp_connectors.providers.feed.compari.manifest import manifest
...
class CompariFeedAdapter(FeedPort):
    """Compari.ro feed generator."""
    ...
    def test_connection(self):
        ...
        return ConnectionTestResult(success=True, message="Compari.ro feed generator ready")
            ...
            for item_data in expanded:
                ...
                for field, message, _ in soft_errors:
                    warnings.append(FeedWarning(
                        product_id=feed_item.identifier,
                        field=field,
                        message=message,
                    ))
