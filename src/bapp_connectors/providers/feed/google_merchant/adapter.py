"""
Google Merchant Center feed adapter — implements FeedPort.
"""
...
from bapp_connectors.providers.feed.google_merchant.manifest import manifest
...
class GoogleMerchantFeedAdapter(FeedPort):
    ...
    def validate_credentials(self) -> bool:
        return True  # No credentials needed for generation-only
    ...
    def test_connection(self):
        ...
        return ConnectionTestResult(success=True, message="Google Merchant feed generator ready")
    ...
    def generate_feed(self, products: list[Product]) -> FeedResult:
        ...
        feed_format = self.config.get("feed_format", "xml")
        ...
        if feed_format == "csv":
            content = feed_items_to_csv(valid_items)
